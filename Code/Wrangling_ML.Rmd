...
## Wrangling
```{r}
energy.data.plant <- read.csv("../Data/Raw/2___Plant_Y2020_ready.csv")
...
```{r}
energy.data.generator <- read.csv("../Data/Raw/3_1_Generator_Y2020.csv")
...
write.csv(energy.data.plant.generator.NC, row.names = FALSE, 
          file = "../Data/Processed/longlat_generators_NC")
