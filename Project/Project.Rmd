...
<<<<<<< HEAD
There is a marked difference in median household income across counties in North Carolina. Orange and Wake have values over \$100,000, while Halifax and Robeson fall below \$50,000. 
=======
...
>>>>>>> abfdec1161a3a4ededef7aba41f46321797b03fb
...
<<<<<<< HEAD
Energy generators are diverse in type and widespread throughout the state. Yet while solar appears to be the most abundant, it makes up small fraction of total energy generation. Conversely, there are only 5 nuclear sites, yet it makes up a third of the state's energy production.
=======
...
dim(generators[generators$FuelType=="Nuclear",])
